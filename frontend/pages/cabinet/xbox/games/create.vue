    ...
    <div class="wrapper">
        ...
        <VeeForm v-slot="{ validate }" class="xbox-games-create">
            ...
            <div class="xbox-games-create__platforms">
                <div class="xbox-games-create__platforms-agreement">
                    <VeeField id="applicationFormConfirm" v-model="confirmed" name="confirm" type="checkbox"
                        :rules="{ required: true }" />

                    <label for="applicationFormConfirm">
                        <span class="xbox-games-create__platforms-agreement-checkbox" :class="{ 'is-active': confirmed }">
            ...
            <Transition>
                <div v-show="conditions" @click="clearFrom" class="xbox-games-create__clear-from">
                    <span class="material-symbols-outlined">close</span>
                </div>
            </Transition>
        </VeeForm>
