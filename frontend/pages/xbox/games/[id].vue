    ...
    <div class="card-wrapper">
        <div class="product-card">
            ...
            <div class="product-card__body">
                ...
                <div class="product-card__body-platforms">Доступные платформы:
                    <div v-for="platform in product.platforms" :key="platform.id" class="product-card__body-platforms-item">
                        {{ platform }}
                    </div>
                </div>
                <div class="product-card__body-size">Трепбования по памяти: {{ product.memory }} GB</div>
                ...
                <!-- <div class="product-card__body-title">Системные требования:</div>
                    ...
                    <div class="product-card__body-requirements-cell">{{ fortnightProducts[0].requirements.min.system }}
                    </div>
                    <div class="product-card__body-requirements-cell">{{
                        fortnightProducts[0].requirements.recommended.system }}</div>
                    ...
                    <div class="product-card__body-requirements-cell">{{ fortnightProducts[0].requirements.recommended.cpu
                    }}</div>

                    <div class="product-card__body-requirements-title">Графика:</div>
                    <div class="product-card__body-requirements-cell">{{ fortnightProducts[0].requirements.min.graphics }}
                    </div>
                    <div class="product-card__body-requirements-cell">{{
                        fortnightProducts[0].requirements.recommended.graphics }}</div>
                    ...
                    <div class="product-card__body-requirements-cell">{{ fortnightProducts[0].requirements.recommended.ram
                    }}</div>
            </div>  -->
            </div>
        </div>
...
const { data: product } = await useFetch(`${url}/xbox/games/${id}`);
